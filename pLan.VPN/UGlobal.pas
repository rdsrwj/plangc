...
const
  ...
  AppVersion     = '0.6.58';               // Отображаемая версия программы, также составляет часть HTTPGet.UserAgent
  AppBuild       = 58;                     // Билд программы, используется при проверке обновлений.
