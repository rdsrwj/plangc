...
public:
    ...
    BOOL ConvertStaticToHyperlink(HWND hwndCtl, const char *strURL);
    BOOL ConvertStaticToHyperlink(HWND hwndParent, UINT uiCtlId, const char *strURL);
...
protected:
	...
	char     m_strURL[MAXURLSZ];                    // hyperlink URL
