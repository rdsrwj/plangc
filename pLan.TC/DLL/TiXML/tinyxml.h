...
public:
	...
	*/	
	...
	int	QueryDwordAttribute( const char* name, unsigned int* value ) const;
	int	QueryLongAttribute( const char* name, long* value ) const;
	...
	*/
	...
	int	QueryDwordAttribute( const std::string& name, unsigned int* value ) const	{ return QueryDwordAttribute( name.c_str(), value ); }
	int	QueryLongAttribute( const std::string& name, long* value ) const			{ return QueryLongAttribute( name.c_str(), value ); }
	int QueryDoubleAttribute( const std::string& name, double* value ) const		{ return QueryDoubleAttribute( name.c_str(), value ); }
	int QueryFloatAttribute( const std::string& name, float* value ) const			{ return QueryFloatAttribute( name.c_str(), value ); }
