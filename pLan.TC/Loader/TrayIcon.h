...
public:
  ...
  virtual UINT SetTimer(UINT nIDEvent, UINT nElapse, void (CALLBACK* lpfnTimer)(HWND, UINT, UINT, DWORD)) =0;
...
public:
  ...
  UINT SetTimer(UINT nIDEvent, UINT nElapse, void (CALLBACK* lpfnTimer)(HWND, UINT, UINT, DWORD)) {return CTrayIcon::SetTimer(nIDEvent, nElapse, lpfnTimer);}
  BOOL KillTimer(int nIDEvent) {return CTrayIcon::KillTimer(nIDEvent);}
...
public:
  ...
  UINT SetTimer(UINT nIDEvent, UINT nElapse, void (CALLBACK* lpfnTimer)(HWND, UINT, UINT, DWORD)) {return CMenuTrayIcon::SetTimer(nIDEvent, nElapse, lpfnTimer);}
  BOOL KillTimer(int nIDEvent) {return CMenuTrayIcon::KillTimer(nIDEvent);}
